...
class DiseaseDatabase:
    ...
    def match_image(self, user_img_path, threshold=15):
        """Match user image against database"""
        try:
    ...
    def _color_distance(self, hex1, hex2):
        ...
        try:
            ...
            def hex_to_lab(hex_color):
                ...
                return sRGBColor(*rgb).convert_to('lab')
                
            color1 = hex_to_lab(hex1)
            color2 = hex_to_lab(hex2)
